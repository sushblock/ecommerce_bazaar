...
function Home() {
  ...
  const handleCategoryChange = (event) => {
    ...
    if (selectedCategory !== 'all') {
      ...
      setFilteredBrands(Array.from(new Set(productsData.products.map((product) => product.brand))));
    }
  };
  ...
  const handleBrandChange = (event) => {
    ...
    if (selectedBrand !== 'all') {
      ...
      setFilteredCategories(Array.from(new Set(productsData.products.map((product) => product.category))));
    }
  };
    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__filter">
          <h4 htmlFor="category" className="home_label_width">Category:</h4>
          <select id="category" value={categoryFilter} onChange={handleCategoryChange} className="home_filter_width">
        ...
        <div className="home__filter">
        <h4 htmlFor="brand"  className="home_label_width">Brand:</h4>
          <select id="brand" value={brandFilter} onChange={handleBrandChange}  className="home_filter_width">
            <option value="all">All</option>
